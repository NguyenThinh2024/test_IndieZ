...
{
    public static class ThinhAnalytics
    {
        private const string LogPrefix = "[Thinh.Analytics]";

        private static IThinhAnalyticsProvider provider;
        private static float sessionStartTime;
        private static bool hasStarted;
        private static bool hasFinished;

        public static void SetProvider(IThinhAnalyticsProvider analyticsProvider)
        {
            provider = analyticsProvider;
        }

        public static void ClearProvider(IThinhAnalyticsProvider analyticsProvider)
        {
